...
%     pop_summary_AR_eeg_detection(EEG,'');
    ...
    % Save filtered ERP
    ERP.erpname  = 'erp1_30hzlpf_mastoidref_-200to0preblc';
    ...
    pop_summary_AR_erp_detection(ERP,fullfile(par_erps_out_dir,'erp1_art_summary_30hzlpf_mastoidref_-200to0preblc.txt')); % This saves it to a file
    ...
    % Export artifact summary to text file
    pop_summary_AR_erp_detection(ERP,''); % This prints it to the screen
    pop_summary_AR_erp_detection(ERP,fullfile(par_erps_out_dir,'erp2_binops_art_summary_30hzlpf_mastoidref_-200to0preblc.txt')); % This saves it to a file
    ...
    % Save ERP
    ERP.erpname  = 'erp2_binops_30hzlpf_mastoidref_-200to0preblc';
    ERP.filename = sprintf('%s.erp',ERP.erpname);
    ERP.filepath = par_erps_out_dir;
    ERP.subject  = participant;
    pop_savemyerp( ERP );
    ...
    saveas(f,fullfile(par_fig_out_dir,'erp2_trialtype_ERPs_30hzlpf_mastoidref_-200to0preblc.png'));
    ...
    f.Position = [500 50 1100 1000];
    f.PaperPositionMode = 'auto';
    saveas(f,fullfile(par_fig_out_dir,'erp2_sme_deHITvMISS_ERPs_30hzlpf_mastoidref_-200to0preblc.png'));
    if ~examine_figures, close(f); end
    ...
    % Save this figure
    f = gcf;
    saveas(f,fullfile(par_fig_out_dir,'erp2_deSME_diffwave_scalpmap.png'));
    if ~examine_figures, close(f); end
    ...
    f.Position = [500 50 1100 1000];
    f.PaperPositionMode = 'auto';
    saveas(f,fullfile(par_fig_out_dir,'erp2_sme_abTrials_abHITvMISS_ERPs_30hzlpf_mastoidref_-200to0preblc.png'));
    if ~examine_figures, close(f); end
    ...
    % Save this figure
    f = gcf;
    saveas(f,fullfile(par_fig_out_dir,'erp2_abTrials_abSME_diffwave_scalpmap.png'));
    if ~examine_figures, close(f); end
    ...
    f.Position = [500 50 1100 1000];
    f.PaperPositionMode = 'auto';
    saveas(f,fullfile(par_fig_out_dir,'erp2_sme_abTrials_acHITvMISS_ERPs_30hzlpf_mastoidref_-200to0preblc.png'));
    if ~examine_figures, close(f); end
    ...
    % Save this figure
    f = gcf;
    saveas(f,fullfile(par_fig_out_dir,'erp2_abTrials_acSME_diffwave_scalpmap.png'));
    if ~examine_figures, close(f); end
    ...
    f.Position = [500 50 1100 1000];
    f.PaperPositionMode = 'auto';
    saveas(f,fullfile(par_fig_out_dir,'erp2_sme_acTrials_acHITvMISS_ERPs_30hzlpf_mastoidref_-200to0preblc.png'));
    if ~examine_figures, close(f); end
    ...
    % Save this figure
    f = gcf;
    saveas(f,fullfile(par_fig_out_dir,'erp2_acTrials_acSME_diffwave_scalpmap.png'));
    if ~examine_figures, close(f); end
    ...
    f.Position = [500 50 1100 1000];
    f.PaperPositionMode = 'auto';
    saveas(f,fullfile(par_fig_out_dir,'erp2_sme_acTrials_abHITvMISS_ERPs_30hzlpf_mastoidref_-200to0preblc.png'));
    if ~examine_figures, close(f); end
    ...
    % Save this figure
    f = gcf;
    saveas(f,fullfile(par_fig_out_dir,'erp2_acTrials_abSME_diffwave_scalpmap.png'));
    if ~examine_figures, close(f); end
